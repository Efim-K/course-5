...
def main():
    ...
    if choice == '1':
        data_base.get_companies_and_vacancies_count()
    elif choice == '2':
        data_base.get_all_vacancies()
    elif choice == '3':
        data_base.get_avg_salary()
    elif choice == '4':
        pdata_base.get_vacancies_with_higher_salary()
    elif choice == '5':
        keyword = str(input('Введите слово для поиска в названии вакансии:\n'))
        data_base.get_vacancies_with_keyword(keyword)
